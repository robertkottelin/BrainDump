        ...
        <div className="row">
          <main role="main" className="col-lg-12 ml-auto mr-auto" style={{ maxWidth: '500px' }}>
            <div className="content mr-auto ml-auto mx-auto" style={{ width: '100%' }}>
                ...
                <button type="submit" className="btn btn-primary btn-block">Save to the blockchain</button>            
              </form>
              <p>&nbsp;</p>
              { this.props.datamapping.map((data, key) => {
                const thisaccount = data[2]
                console.log(typeof(App.thisuser.toString()))
                // If the connected account is the same as in the datamapping, then we can show the data
